 ...
 *
 *         Credit to nisovin (http://forums.bukkit.org/threads/experienceutils-make-giving-taking-exp-a-bit-more-intuitive.54450/#post-1067480) for an implementation that
 *         avoids the problems of getTotalExperience(), which doesn't work properly after a player has enchanted something.
 *
...
public class ExpUtil {
    ...
    public static void setHardMaxLevel(int hardMaxLevel) {
        ExpUtil.hardMaxLevel = hardMaxLevel;
    }
    ...
    /**
     * Calculate the level that the given XP quantity corresponds to, without using the lookup tables. This is needed if getLevelForExp() is called with an XP quantity
     * beyond the range of the existing lookup tables.
     *
     * @param exp
     * @return
     */
    ...
    /**
     * Adjust the player's XP by the given amount in an intelligent fashion. Works around some of the non-intuitive behavior of the basic Bukkit player.giveExp() method.
     *
     * @param amt
